    ...
    <div class="row no-gutters">
        <div class="col no-gutters">
            <nav class="navbar navbar-light bg-success pl-5">
                <h4><a href="https://twitter.com/dnmri03" target="_blank"><i class="bi bi-twitter cursor-pointer text-white"></i></a></h4>
                <h4><a href="https://instagram.com/dp.espiritu" target="_blank"><i class="bi bi-instagram cursor-pointer ml-2 text-white"></i></a></h4>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-12">
                ...
                <div class="nav-links text-center border-bottom pb-4 mb-5">
                    <a href="/">Home</a> •
                    <a href="{{route('posts.topics')}}">Topics</a> •
                    <a href="">Tags</a> •
                    <a href="">About</a>
                </div>
            </div>
